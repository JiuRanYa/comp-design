...
关于`Arsenal Design`的所有文档均在`bole-design/web/docs`目录下
...
比如您想在`Arsenal Design`项目下新增`测试`的导航栏

![image](/arsenal-design/docs/1.png)
...
如上我们已经为`Arsenal Design`添加了一个头部标题为`测试`，对应的目录为`/contribute/start`，

现在我们需要项目目录下，新增一个markdown文件，路径与上方配置保持一致

![image](/arsenal-design/docs/markdown.png)

接下来在markdown编写即可，如果您有更高级的定制需求，可查看 [Markdown插件](/projects/arsenal-design/contribute/mk-plugin)
