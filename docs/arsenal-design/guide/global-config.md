...
`arsenal-design`提供了全局的配置功能，你可以在引入时配置不同组件的默认属性
...
`arsenal-design`可根据你的项目来自行修改前缀，包括`组件前缀`和`样式前缀`
...
'arsenal-design'的样式文件也可提供不同的命名空间，你可以在引入 sass 时这样配置

```sass
@use 'arsenal-design/styles' with (
  $namespace: 'pd'
);
