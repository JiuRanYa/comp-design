...
const distCssBundle = path.resolve(buildOutput, 'arsenal-design/css')
const cssDir = resolve(buildOutput, 'arsenal-design/css')
...
function copySassSource() {
  ...
  return src(path.resolve(__dirname, 'styles/**')).pipe(
